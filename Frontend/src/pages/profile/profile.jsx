  ...
  return (
    ...
    >
      <Grid container spacing={3} style={{ marginTop: '-110px', transform: 'scale(0.92)', marginLeft: '-180px' }}>
        <Grid item xs={12}>
          <Typography variant="h4" gutterBottom style={{ color: '#f1860b', fontSize: '35px', fontWeight: '800', fontFamily: 'Times New Roman', transform: 'translateY(60px)' }}>
            Hi, {formData.first_name}!
          </Typography>
          <Typography variant="h4" gutterBottom>
            <Avatar sx={{ width: 150, height: 150, backgroundColor: '#f1860b', borderRadius: '10%', transform: 'translateY(60px)' }}>
        ...
        <Grid item xs={12} md={8}>
          <Box mt={4} display="flex" justifyContent="left">
            {isEditing ? (
              ...
              <IconButton color="primary" aria-label="edit" onClick={toggleEditing} sx={{ color: 'green', fontSize: '17px', fontWeight: '700', transform: 'translateX(-7px)' }}>
                <span style={{ color: '#f1860b' }}>
                  {isPharmacist ? 'Pharmacist details' : 'Patient details'}
                </span>
                <EditTwoToneIcon sx={{ color: '#f1860b', fontSize: '20px' }} />
              </IconButton>
            )}
          </Box>
          <div>
            ...
            {isEditing ? (
              ...
              <span style={{ color: '#f1860b', fontSize: '14px', fontWeight: '700' }}>
                {formData.first_name}
              </span>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <span style={{ color: '#f1860b', fontSize: '14px', fontWeight: '700' }}>{formData.gender}</span>
            )}
          </div>
          <br />
          <div>
