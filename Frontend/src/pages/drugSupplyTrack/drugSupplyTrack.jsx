...
const DrugSupplyTracker = () => {
  ...
  return (
    <div>
      ...
      <Typography variant="h3" style={{ color: '#f1860b', fontWeight: 'bold', marginBottom: '20px', fontFamily: 'Times New Roman, serif' }}>
        Drug Supply Tracker
      </Typography>
      {medications.map((medication, index) => (
        <div key={medication.id} style={{ display: 'flex', marginBottom: '10px' }}>
          <Card
            style={{
              borderRadius: '50px',
              backgroundColor: index === 0 ? '#f1860b' : 'white',
              color: index === 0 ? 'white' : '#f1860b',
              ...
              <div style={{ display: 'flex', alignItems: 'center', maxHeight: '120px' }}>
                ...
                <div>
                  ...
                  <Typography variant="body1" style={{ color: '#acacac', marginTop: '10px' }}>
                    Hospital Name: <span style={{ color: '#f1860b' }}>{medication.hospital_name}</span>
                  </Typography>
                  <Typography variant="body1" style={{ color: '#acacac' }}>
                    Hospital Address: <span style={{ color: '#f1860b' }}>{medication.hospital_address}</span>
                  </Typography>
                  <Typography variant="body1" style={{ color: '#acacac' }}>
                    Doctor Name: <span style={{ color: '#f1860b' }}>{medication.doctor_name}</span>
                  </Typography>
                </div>
              </div>
            </CardContent>
